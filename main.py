import os,random,requests,anthropic
...
def main():
    ...
    r=requests.post(f"{os.environ['WP_URL']}/index.php?rest_route=/wp/v2/posts",json={"title":k[1],"content":c,"status":"draft"},auth=(os.environ["WP_USER"],os.environ["WP_APP_PASSWORD"]))
