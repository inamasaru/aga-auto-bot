...
def main():
    ...
    r=requests.post(f"{os.environ['WP_URL']}/wp-json/wp/v2/posts",json={"title":k[1],"content":c,"status":"draft"},headers={"Authorization":f"Basic {cred}","Content-Type":"application/json"})
